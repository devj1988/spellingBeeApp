...
export class Cell extends React.Component<CellProps> {
    ...
    render() {
        ...
        return (
            <svg className="cell" width={104} height={104} viewBox="0 0 120 103.92304845413263" onClick={() => { this.props.handleClick(this.props.letter) }}>
                ...
                <text x="40%" y="55%" style={{ color: "black" }}>{this.props.letter}</text>
            </svg>
        );
    }
}